...
<html lang="en">
	<head>
	  <title>Febrian_ID ft Shellvy</title>
	  <meta charset="utf-8">
		...
		<script type="text/javascript">
			...
			function startTime() {
				...
				if (H<5){
					...
					txt='Good Evening Shellvy:)';
					if(txt != txt2 && !starting)
						document.getElementById("quote").innerHTML = txt;
					txt2=txt;
				}
				else if(H<=24){
					txt='Time to Sleep, Good Night Shellvy:)';
					if(txt != txt2 && !starting)
						document.getElementById("quote").innerHTML = txt;
					txt2=txt;
				}
